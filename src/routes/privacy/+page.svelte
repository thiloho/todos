<div class="max-w-prose mx-auto flex flex-col gap-8">
	...
	<section class="flex flex-col gap-4">
		...
		<ul>
			...
			<li>
				<p>
					<strong>Application</strong> refers to Todos, the software program provided by the Company.
				</p>
			</li>
			<li>
				<p>
					<strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
					or &quot;Our&quot; in this Agreement) refers to Todos.
				</p>
			</li>
			<li>
	...
	<section class="flex flex-col gap-4">
		...
		<ul>
			<li>By email: contact@thilohohlt.com</li>
		</ul>
	</section>
</div>
